...
1. Train the model on train and validation sets:
    ...
    ```
    python run_param_tuner.py --config config/DIN_microlens_mmctr_tuner_config_allemb5.yaml --gpu 1 2 3 4 5 6 7
    python run_param_tuner.py --config config/DIN_microlens_mmctr_tuner_config_test.yaml --gpu 5
    python run_param_tuner.py --config config/EMB_all_emb_cb02.yaml --gpu 4 5 6 7 --script run_all_embedding
    ```
...
2. Make predictions on the test set:
    ...
    ```
    python prediction.py --config config/DIN_microlens_mmctr_tuner_config_allemb4 --expid DIN_MicroLens_1M_x1_004_8498f8ff --gpu 1
    python encode_all_emb.py --config config/EMB_all_emb_cb02 --expid EMB_cb_allemb_003_65a7a0bc --gpu 3
    ```
