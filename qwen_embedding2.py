...
import time
import os
dashscope.api_key = "sk-218f8ad655cb4dce9cd61f02dec29c15"
...
for i in tqdm(range(start_id, 91719), total=91719-80000):
    ...
    if i % 10000 == 0:
        ...
        np.save("dataset/MicroLens_1M_MMCTR/qw_data_1.npy", qw_data)
